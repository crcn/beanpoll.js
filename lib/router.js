  ...
  Router = (function() {
    ...
    */
    ...
    Router.prototype.request = function(channelOrMessage, query, headers) {
      var writer;
      writer = channelOrMessage instanceof MessageWriter ? channelOrMessage : new MessageWriter(crema.parseChannel(channelOrMessage), this);
      writer.options({
        query: query,
        headers: headers
      });
    ...
    */
    ...
    Router.prototype.push = function(channelOrMessage, data, query, headers) {
      return this.request(channelOrMessage, query, headers).push(data);
    };
