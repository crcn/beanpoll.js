(function() {
  ...
  exports.Reader = RequestReader = (function(_super) {
    ...
    */
    ...
    function RequestReader(writer, from, channel, query, sanitized, headers, filter, callback) {
      this.writer = writer;
      this.from = from;
  ...
  exports.Writer = RequestWriter = (function(_super) {
    ...
    */
    ...
    RequestWriter.prototype.reader = function(index, numListeners) {
      return new RequestReader(this, this.from, this.channel, this.query, this.sanitized, this.headers, this.filter, this.callback);
    };
