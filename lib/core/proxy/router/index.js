...
var Request = Structr({
	...
	'_passThru': function(ops, allThru, callback)
	{
		...
		if(allThru.length)
		{
			...
			return this.router.dispatch(utils.replaceParams(Parser.parse(thru), this.data), this.data, { target: this.target || this }, function()
			{	
...
var Router = Structr({
	...
	'__construct': function(ops)
	{
		...
		this._middleware = ops.proxy.middleware || middleware(this);
	},
