...
var HookConnection = Structr({  
	...
	/**
	 * @param proxy the proxy we're hooking to
	...
	{    
		...
		{             
			...
			self._remoteProxy.cluster = hook.cluster;
			...
			self._proxy.push('hook/connection', null, { from : self._remoteProxy }); 
	...
	'_reset': function()
	{
		...
		this._remoteProxy.middleware.add(require('./middleware/hook'))
