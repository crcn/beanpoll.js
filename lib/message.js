(function() {
  ...
  exports.Reader = MessageReader = (function(_super) {
    ...
    */
    ...
    function MessageReader(writer, from, channel, query, headers, filter, callback) {
      this.writer = writer;
      this.from = from;
  ...
  exports.Writer = MessageWriter = (function(_super) {
    ...
    */
    ...
    MessageWriter.prototype.reader = function(index, numListeners) {
      return new MessageReader(this, this.from, this.channel, this.query, this.headers, this.filter, this.callback);
    };
  ...
  exports.Builder = (function() {
    ...
    */
    ...
    _Class.prototype.tag = function(keyOrTags, value) {
      return this._objParam('headers', arguments, function(value) {
    ...
    */
    ...
    _Class.prototype._objParam = function(name, args, getValue) {
      ...
      if (typeof keyOrObj === 'string') {
        ...
        this._ops.headers[keyOrObj] = getValue != null ? getValue : getValue({
          value: value
        });
      } else {
        for (key in keyOrObj) {
