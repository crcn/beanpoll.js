  ...
  module.exports = AbstractDispatcher = (function() {
    ...
    */
    ...
    AbstractDispatcher.prototype.dispatch = function(message) {
      ...
      listeners = this._findListeners(message);
    ...
    */
    ...
    AbstractDispatcher.prototype._findListeners = function(route) {
      return this._filterListeners(this._collection.getRouteListeners(route.channel), route.tags);
    };
